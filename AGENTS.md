...
- **The active plan defines scope.** v2 candidates (auto-send mode, .txt/image drops, right-click handler) are explicitly out of v1 — don't implement them incidentally.
